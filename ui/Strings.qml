...
Singleton {
    ...
    readonly property string navLookHint: tr ? "Stil, biçim, boyut" : "Style, mount, size"
    ...
    readonly property string pageLookHint: tr ? "Widget'ın nasıl göründüğü ve kenara nasıl bağlandığı." : "How the widget looks and meets the edge."
