...
Singleton {
    ...
    readonly property string providers: tr ? "Sağlayıcılar · sıra ve renk" : "Providers · order and colour"
    readonly property string auraHint: tr ? "Aura'da Super + ← / → bu sırayla geçer. Renk, Aura temasının rengidir." : "In aura, Super + ← / → steps through this order. The colour is aura's tint."
